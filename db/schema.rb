...
ActiveRecord::Schema.define(version: 20170904151520) do
  ...
  create_table "followings", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["following_id"], name: "index_followings_on_following_id", using: :btree
    t.index ["profile_id"], name: "index_followings_on_profile_id", using: :btree
  end
